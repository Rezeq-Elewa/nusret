...
public class EditUserProfileResponse extends ApiResponse {
    ...
    public EditUserProfileResponse(boolean status, ArrayList<String> result, String error_num, String error) {
